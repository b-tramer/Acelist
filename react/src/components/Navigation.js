      ...
      <div className="nav-bar-div">
        <div className='row'>
          ...
          <div className="small-6 large-10 columns" id="logo-center">
            <span id='nav-logo-mobile'> <Link to='/'> <img src={assetHelper["Acelist-Logo-New.png"]} height="150" width="162"/> </Link> </span>
          </div>

          <div className="small-3 large-1 columns profile" id='menu-profile-div'>
            <span id='nav-profile-icon'> <a href={`/users/${userId}`}> <img src={profileImage} height="36" width="35"/> </a> </span>
          </div>
        </div>
      </div>
      ...
      <div className="show-for-medium">
        <div className="nav-bar-div">
          ...
          <div className='row'>
            ...
            <div className="small-6 large-10 columns" id="logo-center">
              <span id='nav-logo'> <Link to='/'> <img src={assetHelper["Acelist-Logo-New.png"]} height="150" width="220"/> </Link> </span>
            </div>
